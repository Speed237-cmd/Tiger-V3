...
//YouTube: @sMICKEY-MODS
//Instagram: speed-tech
//Telegram: https://t.me/MICKEYMODS999
//GitHub: @
//WhatsApp: +237651707126
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@Speed-tech
   ...
   if (pairingCode && !XeonBotInc.authState.creds.registered) {
      ...
      if (!!phoneNumber) {
         ...
         if (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
            console.log(chalk.bgBlack(chalk.redBright("Start with country code of your WhatsApp Number, Example : +237651707126")))
            process.exit(0)
         }
      } else {
         phoneNumber = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFor example: +237651707126 : `)))
         phoneNumber = phoneNumber.replace(/[^0-9]/g, '')
...
XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
	        ...
	        console.log(chalk.magenta(`\n${themeemoji} YT CHANNEL: MICKEY-MODS`))
            console.log(chalk.magenta(`${themeemoji} GITHUB: `))
            console.log(chalk.magenta(`${themeemoji} INSTAGRAM: @.ay `))
